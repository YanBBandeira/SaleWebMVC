...
namespace SalesWebMVC.Migrations
{
    ...
    [Migration("20251030193917_CorrectSupplierForeignKey")]
    partial class CorrectSupplierForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesWebMVC.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SalesWebMVC.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SalesWebMVC.Models.City", b =>
                {
                    b.HasOne("SalesWebMVC.Models.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("SalesWebMVC.Models.Product", b =>
                {
                    b.HasOne("SalesWebMVC.Models.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("SalesWebMVC.Models.SalesRecord", b =>
                {
                    b.HasOne("SalesWebMVC.Models.City", null)
